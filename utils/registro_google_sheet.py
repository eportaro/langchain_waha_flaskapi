...
class RegistroGoogleSheet:
    ...
    def registrar_google_sheets(self, nombre,correo,programa):
        ##obtener los datos de google sheets
        sheet_id="1uBh5AcRxbaGo9rWdlMBpW8gYuoZZp7yITbOU5UEkv6Q"
        ...
        try:
            ...
            service_account_path='project-chatbot-openai-c5abe5823e9f.json'
...
#     registrador.registrar_google_sheets(nombre="Jeanpier Ancori" , correo="tarara.tarara@gmail.com" , programa="Data Engineer Program")